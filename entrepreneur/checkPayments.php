      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-primary">
            ...
            <div class="container" style="padding-top:30px;width:auto;">
              <center>
                <table class="table" style="width:90%;margin-left:50px;margin-top:30px;">
                  <thead>
                    <tr>
                      <th style="border-bottom: none" class="text-center">
                        <h3 style="margin-left:30px;" >การชำระเงิน</h3>
                      </th>
                      <th style="border-bottom: none" class="text-center">
                        <h3 style="margin-left:30px;">วิธีการชำระเงิน</h3>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr class="text-center">
                      ...
                      <td style="border-top:none">
                        <img src="https://f.ptcdn.info/981/049/000/on540cc0aIIfp9l0Tc7-o.jpg" alt="" class="img-responsive center-block">
                      </td>
                    </tr>

                  </tbody>
                </table>
                <p style="margin-bottom:20px;margin-top:30px;margin-left:70px;">
