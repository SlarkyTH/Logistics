...
<table class="table">
  <tr >
    <th colspan="3"><center><h3>ข้อมูลสินค้า</h3></center></th>
  </tr>
  <tr>
    <th>ประเภทที่ 1</th>
    <th>ประเภทที่ 2</th>
  ...
  <tr>
    <td>จำนวน <input type="text" name="fname"> กล่อง</td>
    <td>จำนวน <input type="text" name="fname"> กล่อง</td>
    <td>จำนวน <input type="text" name="fname"> กล่อง</td>
  </tr>
  <tr>
  <td>น้ำหนัก <input type="text" name="fname"> ก.ก.</td>
  <td>น้ำหนัก <input type="text" name="fname"> ก.ก.</td>
  <td>น้ำหนัก <input type="text" name="fname"> ก.ก.</td>
  </tr>
</table>
...
<table class="table">
  <tr >
    <th colspan="4"><center><h3>ข้อมูลการขนส่ง</h3></center></th>
  </tr>
  <tr>
...
<table class="table">
  <tr >
    <th colspan="4"><center><h3>ข้อมูลวัน-เวลา รับ-ส่ง สินค้า</h3></center></th>
  </tr>
  <tr>
    <td>วันรับสินค้า</td>
