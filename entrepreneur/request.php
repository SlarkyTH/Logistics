...
<div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <?php $result = mysql_query("SELECT * FROM car");
                ...
                mysql_free_result($result);?>
             	<!-- <div class="col-lg-4">
                	<div class="thumbnail">
                      <img src="imgs/e57e5a4b502198e6ff6ab617fe046546.jpg" class="img-responsive">
                      <div class="caption">
                        <h3>Thumbnail label</h3>
                        <p>...</p>
                        <p>
                            <center><a href="#" class="btn btn-primary" role="button">Request</a></center>
                       </p>
                      </div>
                    </div>
                </div>
