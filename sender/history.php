...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><span class="box-title">History</span></h1>
    </section>
            ...
            <div class="box-body">
              ...
              <ul class="todo-list">
                <li> <span> <i class="fa fa-ellipsis-v"></i> <i class="fa fa-ellipsis-v"></i> </span>
                  ...
                  <div class="tools"> <i class="fa fa-trash-o"></i> </div>
                </li>
                <li> <span> <i class="fa fa-ellipsis-v"></i> <i class="fa fa-ellipsis-v"></i> </span>
                  <!-- todo text -->
                ...
                <li> <span> <i class="fa fa-ellipsis-v"></i> <i class="fa fa-ellipsis-v"></i> </span>
              	...
              	<div class="box-footer clearfix no-border">
              		<button type="button" class="btn btn-default pull-right"><i class="ion ion-trash-a"></i> Clear History</button>
            	</div>
            </div>
            <!-- /.box-body -->
          </div>
