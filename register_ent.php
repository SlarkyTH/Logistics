...
if(isset($_POST["submit"])){
	...
	mysql_query("INSERT INTO `entrepreneur` (
	`Enter_Id`, 
	`Enter_Name`, 
	`Enter_Company`, 
	`Enter_Address`, 
	...
	mysql_query("INSERT INTO `login` (`log_id`, `log_user`, `log_passwd`, `log_user_ref`, `log_user_type`) VALUES (NULL, '".$_POST["user"]."', '".$_POST["passwd"]."', '".$user_ref."', 'entrepreneur');");
...
<div class="container-fluid">
	...
	<div class="jumbotron jumbotron-fluid">
      <div class="container">
        <h1 class="display-3">Become Entrepreneur</h1>
        <p class="lead">Register the form to be Entrepreneur.</p>
        <p class="lead">
